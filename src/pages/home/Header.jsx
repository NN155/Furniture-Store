...
function Header() {
    return (
        <header className="header">
                ...
                <div className="main">
            <div className="col-sm-4 flex-d aligh-items-center justify-content-center mt-4">
                <h1 className="fz-76 fw-600 color-black">
                    Simple Furniture with <span className="color-gold" style={{ textDecoration: "underline" }}>high-end</span> quality
                </h1>
                <p className="fz-22 color-black">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
